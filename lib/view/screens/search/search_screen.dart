                                            ...
                                            return InkWell(
                                              ...
                                              child: Container(
                                                ...
                                                child: Row(children: [
                                                  ...
                                                  //         .PADDING_SIZE_SMALL),
                                                  Text(
                                                    Get.find<CategoryController>().categoryList[index].name.length > 15? Get.find<CategoryController>().categoryList[index].name.substring(0,15) + "..." : Get.find<CategoryController>().categoryList[index].name,
                                                    style: robotoMedium
                                                        .copyWith(
                                                        fontSize:
                                                        Dimensions
