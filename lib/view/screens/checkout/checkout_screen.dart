                ...
                return GetBuilder<CouponController>(
                  ...
                  return GetBuilder<OrderController>(
                    ...
                    if (restController.restaurant != null) {
                      ...
                      //     text:
                      //        _addressList.isEmpty?'': _addressList[orderController.addressIndex].road);
                      // _houseController = TextEditingController(
                      //     text:
                      //     _addressList.isEmpty?'':  _addressList[orderController.addressIndex].house);
                      // _floorController = TextEditingController(
                      //     text:
                      //     _addressList.isEmpty?'':   _addressList[orderController.addressIndex].floor);
                                              ...
                                              children: [
                                                ...
                                                Center(
                                                  child: Text('delivery_charge'
                                                          .tr +
                                                      ': ' +
                                                      '${(orderController.orderType == 'take_away' || (orderController.deliverySelectIndex == 0 ? restController.restaurant.freeDelivery : true)) ? '0.0'.tr : _charge != -1 ? PriceConverter.convertPrice(orderController.deliverySelectIndex == 0 ? _charge : _deliveryCharge) : 'calculating'.tr}'),
                                                )
                                              ]),
                                        ),
                                        SizedBox(
